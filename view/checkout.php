            ...
            <div class="checkout_group checkout_group_total">
                ...
                <div class="c_total">
                    ...
                    <div class="c_total_content">
                        <div class="c_payment">
                            ...
                            <form class="c_payment-title" method="POST" data_type='momo'>
                                <label for="payment3"
                                    class="payment_method-item <?= (isset ($_GET['resultCode'])) ? "active" : "" ?>">
                                    <img class="c_pament-title_img"
                                        src="https://developers.momo.vn/v3/vi/assets/images/square-8c08a00f550e40a2efafea4a005b1232.png"
                                        alt="">
                                    <div class="c_payment-title_name">Thanh toán bằng momo</div>
                                    <input hidden type="submit" id="payment3" name="payment_momo" value="payment_momo" >
                                </label>
                            </form>
                        </div>
                        <script>
                ...
                <div class="c_total">
                    ...
                    <form method="POST" class="c_total_content c_total-end">
                        ...
                        <?php if ((isset ($_GET['vnp_ResponseCode']) && $_GET['vnp_ResponseCode'] == '00')||(isset($_GET['resultCode'])&& $_GET['resultCode'] ==0)) {
                            echo '<div class="c_end-submit disabled">Đang xử lý</div>';
                            if ((isset ($payment_checkcout) && $payment_checkcout->status == false)||(isset($result_momo) && $result_momo->status ==false)) {
