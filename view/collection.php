                                    ...
                                    <div class="cate-more">
                                        ...
                                        if (isset ($value['children']) && $value['children']) {
                                            foreach ($value['children'] as $key => $item) {
                                                echo '<a class="' . ((isset ($_GET['category']) && ($item['slug'] == $_GET['category'])) ? "active" : "") . '" href="?mod=page&act=collection&category=' . $item['slug'] . '">' . $item['name']  . '</a>';
                                            }
                                        }
                                        ?>
                                    </div>
                ...
                <div class="g-nav">
                    ...
                    <div class="g-nav-right">
                        <div class="g-nav-btn-group">
                            ...
                            <?php
                            $urlFilter .= "&type=" . $type;
                            $totalPage = ceil($collectionPro->total / $limit);
                            $page = $_GET['page'] ?? 1;
