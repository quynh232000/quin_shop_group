        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    <div class="row">
                        <?php
                        if (isset($_GET["act"]) && $_GET["act"] = "mn_user_detail") {
                            if (isset($_GET["uid"]) && $_GET["uid"]) {
                                $id = $_GET["uid"];
                                echo "<h2 style='margin-bottom: 24px;'>Chi Tiết User, ID: $id</h2>";
                            } else {
                                echo "<h2 style='margin-bottom: 24px;'>Chi Tiết User</h2>";
                            }
                        }
                        ?>
                    ...
                    if ($user != false) {
                        ...
                        function checkRole($userRole)
                        {
                            switch ($userRole) {
                                case "Member":
                                    return "Thống kê mua hàng của memeber";
                                    break;
                                case "Seller":
                                    return "Thống kê mua hàng của seller";
                                    break;
                                case "Admin":
                                    return "Thống kê mua hàng của admin";
                                    break;
                                case "AdminAll":
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <strong><?= checkNullWithValue($email, "60%", "red") ?></strong>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <strong><?= checkNullWithValue($full_name, "60%", "red") ?></strong>
                                                    </div>
                                                    <div class="form-group">
