    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="form-edit-user" class="forms-sample form-edit-user" method="POST" enctype="multipart/form-data" action="">
                      <div class="form-render-user"></div>
          ...
          <!-- end modal  -->
          <?php
          if (isset($_GET["act"]) && $_GET["act"] = "mn_all_user") {
            echo "<h2 style='margin-bottom: 24px;'>Tất cả User</h2>";
          }
          ?>
                                ...
                                <tr>
                                  <td>
                                    <a style="text-decoration: none;" href="?mod=admin&act=mn_user_detail&uid=<?= $user_id ?>">
                                      <div class="d-flex flex-column gap-3"><?= $user_fullname ?>
                                        <img src="<?= Session::check_image($user_avatar) ?>" alt="">
                                      </div>
                                    </a>
                                  </td>
                                  ...
                                  <td>
                                    <div class="btn-clickable" data-user-id="<?= $user_id ?>" data-type="edit">
                                      <img style="cursor: pointer; width: 20px; height: 20px;" class="" src="assest/upload/setting_771203.png" alt="">
                                    </div>
                                  </td>
                                </tr>
                            <?php }
