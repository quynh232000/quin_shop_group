        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <!-- end modal  -->
                    <?php
                    if (isset($_GET["act"]) && $_GET["act"] = "mn_all_products") {
                        echo "<h2 style='margin-bottom: 24px;'>Tất cả Products</h2>";
                    }
                    ?>
                                    ...
                                    <div class="tab-pane fade show active" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                        <div class="card-body">
                                            <div style="display: flex; justify-content: space-between;">
                                                ...
                                                <div class="<?= isset($result) && $result->status == false ? "alert alert-danger" : "" ?>"><?= isset($result) && $result->status == false ? $result->message : "" ?></div>
                                            </div>
