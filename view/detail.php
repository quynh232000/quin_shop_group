                ...
                <div class="detail-left">
                    <div class="detail-img">
                        <div class="detail-img-show">
                            <img onclick="show_image(this)" src="./assest/upload/<?= $san_pham['product']['image_cover'] ?>" alt="">
                        </div>
                            ...
                            if (count($san_pham['listimage']) > 0) {
                                ...
                                foreach ($san_pham['listimage'] as $key => $value) {
                                    echo ' <div class="detail-img-item">
                                                <img onclick="show_image(this)" src="./assest/upload/' . $value['link'] . '"
                                                    alt="">
                                            </div>';
                                }
                                echo ' <div class="detail-img-item">
                                                <img onclick="show_image(this)" src="./assest/upload/' . $san_pham['product']['image_cover'] . '"
                                                    alt="">
                                            </div>';
                            } else {
                                echo ' <div class="detail-img-item">
                ...
                <div class="detail-right">
                    ...
                    <div class="detail-price">
                        <del class="detail-price-old fm-price">
                            <?php
                             $numb = $san_pham['product']['price'] * (100 /(100 - $san_pham['product']['percent_sale'])) /1000;
                                echo round($numb,0)*1000 ;
                             ?>
                        </del>
                    ...
                    <div class="detail-group">
                        ...
                        <div class="detail-info-quantity">
                            ...
                            <div class="detail-amount-total">
                                <?= $san_pham['product']['quantity']-$san_pham['product']['quantity_sold'] ?> sản phẩm
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="shop-info">
                        <div class="shop-body">
                            <div class="shop-info-left">
                                <div class="shop-img">
                                    <img onclick="show_image(this)" src="./assest/upload/<?= $thong_tin_shop['shop_info']['icon'] ?>" alt="">
                                </div>
