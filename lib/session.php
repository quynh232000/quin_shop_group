...
class Session
{
    ...
    //nhat
    public static function check_AdminAll()
    {
        $role = Session::get('role');
        if ($role != 'AdminAll') {
            return new Response(false, "Bạn không có quyền thực hiện!");
        } else {
            return new Response(true, "Success!");
        }
    }
    public static function check_image($image, $substr = 'assest/upload/')
    {
